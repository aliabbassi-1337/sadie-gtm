...
COUNTRY_TO_CODE = {
    ...
    'Finland': 'FI', 'Nicaragua': 'NI', 'Spain': 'ES', 'España': 'ES',
    'Thailand': 'TH', 'Australia': 'AU', 'United Kingdom': 'GB',
    'Philippines': 'PH', 'Argentina': 'AR', 'Colombia': 'CO', 'Portugal': 'PT',
    'Indonesia': 'ID', 'Costa Rica': 'CR', 'Chile': 'CL', 'Peru': 'PE',
    'Perú': 'PE', 'Singapore': 'SG', 'Guatemala': 'GT', 'Ireland': 'IE',
    'Puerto Rico': 'PR', 'Ecuador': 'EC', 'Malaysia': 'MY', 'Malaisie': 'MY',
    'Morocco': 'MA', 'Panama': 'PA', 'Cambodia': 'KH', 'Uruguay': 'UY',
    'Japan': 'JP', 'Dominican Republic': 'DO', 'Vietnam': 'VN',
    'South Africa': 'ZA', 'Honduras': 'HN', 'Netherlands': 'NL', 'Romania': 'RO',
    'Kenya': 'KE', 'Sweden': 'SE', 'Seychelles': 'SC', 'Aruba': 'AW',
    'Mauritius': 'MU', 'Austria': 'AT', 'Mexico': 'MX', 'México': 'MX',
    'Canada': 'CA', 'Brazil': 'BR', 'Belgium': 'BE', 'Czech Republic': 'CZ',
    'Hungary': 'HU', 'Poland': 'PL', 'Croatia': 'HR', 'Slovenia': 'SI',
    ...
    'Turkey': 'TR', 'Israel': 'IL', 'Egypt': 'EG', 'Saudi Arabia': 'SA',
    'UAE': 'AE', 'United Arab Emirates': 'AE', 'Qatar': 'QA', 'Kuwait': 'KW',
    'Bahrain': 'BH', 'Oman': 'OM', 'Jordan': 'JO', 'Lebanon': 'LB', 'Cyprus': 'CY',
    ...
    'Georgia': 'GE', 'Armenia': 'AM', 'Curacao': 'CW', 'Saint Lucia': 'LC',
    'Bermuda': 'BM', 'Gibraltar': 'GI', 'Guam': 'GU', 'Cape Verde': 'CV',
    'Saint Martin': 'MF', 'Saint Vincent and the Grenadines': 'VC',
    'Caribbean Netherlands': 'BQ', 'Grenada': 'GD', 'Kyrgyzstan': 'KG',
    'Syria': 'SY', 'Burundi': 'BI', 'French Polynesia': 'PF',
    'Guadeloupe': 'GP', 'Guernsey': 'GG', 'British Virgin Islands': 'VG',
    'U.S. Virgin Islands': 'VI', 'Bali': 'ID', 'BALI': 'ID',
}
