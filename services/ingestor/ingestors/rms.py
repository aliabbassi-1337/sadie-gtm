...
- Concurrent browser contexts for performance
"""
...
class RMSIngestor:
    ...
    Usage:
        ...
        result = await ingestor.ingest(start_id=0, end_id=10000)
        
        # Dry run
        result = await ingestor.ingest(start_id=0, end_id=100, dry_run=True)
    """
    
    source_name = "rms_scan"
    external_id_type = "rms_slug"
    
    def __init__(self, repo: Optional[IRMSRepo] = None):
        """Initialize RMS ingestor with optional repo dependency."""
    ...
    async def ingest(
        ...
        Returns:
            RMSIngestResult with scan statistics
        """
